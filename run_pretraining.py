...
def start_training(args, model, optimizer, lr_scheduler, start_epoch):
    ...
    for index in range(start_epoch, args.num_epochs):
        ...
        should_early_stop = (global_step > args.max_steps)
        ...
        if (
            ...
            args.num_epochs_between_checkpoints > 0
...
def main():
    ...
    # args.load_training_checkpoint = '/raid/tamnm8/data/bert/checkpoints/bert_mgk8_scale3_pi_square_final-'
    # args.load_checkpoint_id = 'latest_checkpoint'
