...
from pretraining.configs import PretrainedBertConfig, PretrainedRobertaConfig, MGKPretrainedBertConfig
from pretraining.modeling import BertForPreTraining, BertLMHeadModel
from pretraining.mgk_modeling import MGKBertForPreTraining, MGKBertLMHeadModel
...
MODELS = {
    ...
    "mgk-bert-mlm": (MGKBertLMHeadModel, MGKPretrainedBertConfig, BertTokenizer),
    "mgk-bert-mlm-nsp": (MGKBertForPreTraining, MGKPretrainedBertConfig, BertTokenizer),
    "mgk-bert-mlm-vnese-news": (MGKBertLMHeadModel, MGKPretrainedBertConfig, AutoTokenizer),
    "bert-mlm-vnese-news": (BertLMHeadModel, PretrainedBertConfig, AutoTokenizer)
}
...
class BasePretrainModel(object):
    def __init__(
        ...
        if not tokenizer:
            ...
            # tokenizer = BertTokenizer.from_pretrained('bert-large-uncased', do_lower_case=args.do_lower_case, max_len=512)
