...
class MGKPretrainedBertConfig(PretrainedBertConfig):
    model_type = "roberta"

    def __init__(self, num_attention_heads=6, **kwargs):
        super().__init__(num_attention_heads=num_attention_heads, **kwargs)
